...
function onBeatHit()
    ...
    elseif curBeat == 288 then
        ...
        noteTweenX('A1',0 , defaultNotePos[0 + 1][1], 2, 'quadInOut');
        noteTweenX('B1',1 , defaultNotePos[1 + 1][1], 2, 'quadInOut');
        noteTweenX('C1',2 , defaultNotePos[2 + 1][1], 2, 'quadInOut');
        noteTweenX('D1',3 , defaultNotePos[3 + 1][1], 2, 'quadInOut');
        noteTweenX('E1',4 , defaultNotePos[4 + 1][1], 2, 'quadInOut');
        noteTweenX('F1',5 , defaultNotePos[5 + 1][1], 2, 'quadInOut');
        noteTweenX('G1',6 , defaultNotePos[6 + 1][1], 2, 'quadInOut');
        noteTweenX('H1',7 , defaultNotePos[7 + 1][1], 2, 'quadInOut');

        noteTweenY('A2',0 , defaultNotePos[0 + 1][2], 2, 'quadInOut');
        noteTweenY('B2',1 , defaultNotePos[1 + 1][2], 2, 'quadInOut');
        noteTweenY('C2',2 , defaultNotePos[2 + 1][2], 2, 'quadInOut');
        noteTweenY('D2',3 , defaultNotePos[3 + 1][2], 2, 'quadInOut');
        noteTweenY('E2',4 , defaultNotePos[4 + 1][2], 2, 'quadInOut');
        noteTweenY('F2',5 , defaultNotePos[5 + 1][2], 2, 'quadInOut');
        noteTweenY('G2',6 , defaultNotePos[6 + 1][2], 2, 'quadInOut');
        noteTweenY('H2',7 , defaultNotePos[7 + 1][2], 2, 'quadInOut');

        noteTweenAngle('A3',0 , 0, 2, 'quadInOut');
        noteTweenAngle('B3',1 , 0, 2, 'quadInOut');
        noteTweenAngle('C3',2 , 0, 2, 'quadInOut');
        noteTweenAngle('D3',3 , 0, 2, 'quadInOut');
        noteTweenAngle('E3',4 , 0, 2, 'quadInOut');
        noteTweenAngle('F3',5 , 0, 2, 'quadInOut');
        noteTweenAngle('G3',6 , 0, 2, 'quadInOut');
        noteTweenAngle('H3',7 , 0, 2, 'quadInOut');
    end
